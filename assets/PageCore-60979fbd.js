...
}`,H=e=>O().then(n=>n.parse(e)),z=e=>O().then(n=>n.parseAst(e));function G(){return I(L,{placeholder:B,tabs:[{name:"toJson",file:"plain.json",convert:j(H,e=>JSON.stringify(e,null,2)),render:A},{name:"toAst",file:"ast.json",convert:j(z,e=>JSON.stringify(e,null,2)),render:A}]})}export{G as default};
